...
print('total medals for cananda:', len(canada))
...
for gender in canada:
	if gender[0] == 2014 and gender[3] == "Women":
		women_2014.append(gender)

print('canada had', len(women_2014), 'women winners in 2014')
